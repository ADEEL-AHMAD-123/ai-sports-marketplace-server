...
jest.mock('../../src/services/shared/ApiSportsClient', () => {
  return jest.fn().mockImplementation(() => ({
    get: jest.fn(),
  }));
});

jest.mock('../../src/services/shared/MLBStatsClient', () => ({
  getTeamIdByName: jest.fn(),
  getInjuredListForTeam: jest.fn(),
}));

const { cacheGet, cacheSet } = require('../../src/config/redis');
const mlbStatsClient = require('../../src/services/shared/MLBStatsClient');
