...
const SPORT = 'nhl';
const FINALIZE_AFTER_HOURS = Number(process.env.NHL_FINALIZE_AFTER_HOURS || process.env.POST_GAME_FINALIZE_AFTER_HOURS || 3.5);
const STALE_DELETE_AFTER_HOURS = Number(process.env.NHL_STALE_DELETE_AFTER_HOURS || process.env.POST_GAME_STALE_DELETE_AFTER_HOURS || 30);
...
async function run() {
  ...
  logger.info(`✅ [NHLPostGameSync] Done`, {
    changes,
    deleted,
