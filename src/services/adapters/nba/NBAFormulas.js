...
DATA FLAGS:
  dataQuality=${dataQuality} | form=${hasFullFormWindow ? 'complete' : 'partial'} | edge=${hasFullEdgeWindow ? 'complete' : 'partial'} | baseline=${hasFullBaselineWindow ? 'complete' : 'partial'}
